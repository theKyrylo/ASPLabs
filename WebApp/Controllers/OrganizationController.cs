...
namespace WebApp.Controllers
{
    public class OrganizationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Region,NIP")] OrganizationEntity organizationEntity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Region,NIP")] OrganizationEntity organizationEntity)
        {
